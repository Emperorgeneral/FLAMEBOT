...
$terminalRoots = Find-TerminalRoots
...
$mt4Dest = Pick-One $mt4Targets 'Multiple MT4 installs found. Choose where to install MT4 EA:'
$mt5Dest = Pick-One $mt5Targets 'Multiple MT5 installs found. Choose where to install MT5 EA:'

if ($mt4Dest -eq $null) { Write-Host 'No MT4 target found (skipping MT4 EA).' -ForegroundColor Yellow }
if ($mt5Dest -eq $null) { Write-Host 'No MT5 target found (skipping MT5 EA).' -ForegroundColor Yellow }
